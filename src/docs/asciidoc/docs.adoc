...
=== 기본 지역 설정 (PUT /api/v1/member/region)
...
=== 기본 외출 시간 설정 (PUT /api/v1/member/outingTime)

==== Description

기본 외출 시간 설정 (저장, 수정, 삭제)
...
=== 기본 옷차림 두께 설정 (PUT /api/v1/member/temp-condition)

==== Description

기본 옷차림 두께 설정 (저장, 수정, 삭제)
